...
export const mockEducationalAttainment: EducationalAttainment[] = [
  {
...
export const mockCurriculumVitae: CurriculumVitae[] = [
  {
...
export const mockLicenseCertificates: LicenseCertificate[] = [
  {
